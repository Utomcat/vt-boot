 ...
 * @author ranyk
 * @version V1.0
 * @description: Disruptor 邮件消息队列处理策略实现类
 * @date: 2026-03-24
 */
@Slf4j
@Component
public class EmailDisruptorMqMessageHandlerStrategyImpl implements DisruptorMqMessageHandlerStrategy {
    /**
     * 获取消息类型
     *
    ...
    public MqMessageTypeEnum getMessageType() {
        return MqMessageTypeEnum.EMAIL;
    }
    ...
    public void execute(BaseMessageDTO event) {
        log.debug("Email Disruptor 消息队列处理策略功能开发中, 敬请期待!");
    }
}
